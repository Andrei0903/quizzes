            ...
            return this.each(function(){
                ...
                $(".next").click(function(e){
                    ...
                    if (userAnswer.index() == -1 && !reviewQuiz) {
                        ...
                        let nextId = parseInt(div.attr('id').replace('question-', '')) + 1;
                        //console.log(nextId);

                        let newQuestion = $("#question-" + nextId);
                ...
                $(".prev").click(function(e){
                    let div = $(e.target).closest("div[id*='question-']");

                    let prevId = parseInt(div.attr('id').replace('question-', '')) - 1;

                    let newQuestion = $("#question-" + prevId);
